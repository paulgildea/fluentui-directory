const Directory = 
{
    schema: ['name', 'type', 'website', 'repo', 'package', 'design kit'],
    listing: [
        {
            ...
            'design_kit_url': ['https://aka.ms/fluenttoolkits/web/figma'],
        },
        {
        ...
        },
        {
            ...
            'design_kit_url': ['https://aka.ms/fluenttoolkits/web/figma', 'https://aka.ms/fluenttoolkit', 'https://aka.ms/fluenttoolkits/ios/figma', 'https://aka.ms/fluenttoolkits/android/figma'],
        },
        {
            'name': 'Fluent UI iOS',
            'type': 'Component Library',
            ...
            'design_kit_url': ['https://aka.ms/fluenttoolkits/ios/figma'],
        },
        {
        ...
        },
        {
            ...
            'design_kit_url': ['https://aka.ms/fluenttoolkits/android/figma'],
        },
        {
